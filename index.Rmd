...
The analysis document should detail the steps you took to develop the blog post. This includes where you got the data, other solutions you tried, the statistical methods you chose and your findings. 
...
All the code used and the data set (both raw and processed) should be posted to github as well.
