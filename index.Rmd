...
author:
  - name: Aldo Solari
    ...
    affiliation: DEMS
    affiliation_url: https://www.unimib.it/
date: "`r Sys.Date()`"
...
* *Advanced statistical/machine learning models*, e.g. GAMs, boosting algorithms, ensemble learning
* *Large-scale testing* and *selective inference*
* *High-dimensional inference*, e.g.  sample-splitting inference, stability selection, knockoffs
...
**January 23** Projects presentation: round A
  - Teams: GS, GreenTeam, LAF, Clothster Analysis, JANUARY, PowerTrasform

**January 24** Projects presentation: round B
  -  Hermani, The_Regressionists, Anonymous, Robaskol
  
**January 28** Projects presentation: round C: 
  - D, MSF, CaMelos', IGA, Random_Forest_512
